              ...
              child: ListView(
                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Загальна площа: ${widget.floor.totalArea.toStringAsFixed(0)} м²',
                          ),
                          Text(
                            'Площа кабінетів з ПК: ${calc.computerRoomsArea.toStringAsFixed(0)} м²',
                          ),
                          Text(
                            'Залишкова площа (звичайні приміщення): ${calc.remainingArea.toStringAsFixed(0)} м²',
                          ),
                          ...
                          Text(
                            'Наявна ємність (загальна площа): ${calc.assignedCapacityLiters.toStringAsFixed(1)} од.',
                          ),
                  ...
                  for (final room in _rooms)
                    Builder(
                      builder: (context) {
                        final assigned = room.id != null
                            ? (_extinguishersByRoomId[room.id!] ?? const [])
                            : const [];
                        return ListTile(
                          leading: Icon(
                            room.hasComputer
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    await Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            AllExtinguishersScreen(
                                              initialBuildingId:
                                                  widget.floor.buildingId,
                                              initialFloorId: widget.floor.id,
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => RoomFormScreen(floor: widget.floor),
            ),
          );
          _reload();
        },
